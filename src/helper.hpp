...
// Function to find the car in lane that is closest in front and determines distance and speed
...
// function to determine if a lane is free for changing. It looks 15m in front and 5m behind the vehicle
